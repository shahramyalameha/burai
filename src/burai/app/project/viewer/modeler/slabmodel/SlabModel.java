...
public class SlabModel {
     ...
     * cell is not changed.
     */
    public SlabModel(Cell cell, int h, int k, int l) throws MillerIndexException {
        if (cell == null) {
    ...
    private static class AtomEntry {
        ...
        public AtomEntry(SlabModel parent) {
            if (parent == null) {
    ...
    private boolean setupSlabModel() {
        // lattice
