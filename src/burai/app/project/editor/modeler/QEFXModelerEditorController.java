...
public class QEFXModelerEditorController extends QEFXResultEditorController<QEFXGraphViewerController> {
    ...
    public QEFXModelerEditorController(QEFXProjectController projectController, QEFXGraphViewerController viewerController) {
